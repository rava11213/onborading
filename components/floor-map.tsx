...
export default function FloorMap({ assignedAreas, trackedItems, onRoomClick, isOnboarding = false }: FloorMapProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto bg-white rounded-2xl shadow-2xl p-8">
      ...
      <div className="grid grid-rows-3 gap-0.5 border-4 border-gray-800 bg-gray-800 rounded-xl overflow-hidden">
        {/* Top Row */}
        <div className="grid grid-cols-17 gap-0.5">
          {["N516", "N517", "N518", "N519", "N520", "N521", "N522"].map((room) => (
            <div
              ...
              className={getRoomClassName(
                room,
                "bg-blue-50 border border-blue-200 p-3 text-center font-bold text-xs text-blue-800 flex items-center justify-center h-30 transition-all duration-300",
              )}
          ...
          <div className="flex flex-col gap-0">
            <div
              className={getRoomClassName(
                "N524",
                "bg-pink-100 border border-pink-300 text-pink-800 h-15 text-xs font-bold flex items-center justify-center transition-all duration-300",
              )}
            ...
            <div
              className={getRoomClassName(
                "Nurse Station",
                "bg-green-100 border border-green-300 text-green-800 h-15 text-xs font-bold flex items-center justify-center transition-all duration-300",
              )}
          ...
          {/* Stairs */}
          <div className="bg-gray-100 border border-gray-300 text-gray-800 font-bold flex items-center justify-center p-0 h-30">
          ...
          <div
            className={getRoomClassName(
              "Hall Restroom",
              "bg-white border border-gray-300 text-gray-800 text-xs font-bold flex items-center justify-center h-30 transition-all duration-300",
            )}
